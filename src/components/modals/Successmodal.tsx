...
export default function SuccessModal({
  ...
  return (
    <>
      {/* Overlay */}
      <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-[100] animate-in fade-in" />

      {/* Modal */}
      <div className="fixed inset-0 flex items-center justify-center z-[101] p-4">
        <div className="bg-white rounded-[28px] shadow-2xl max-w-md w-full p-10 text-center animate-in zoom-in duration-300">
          {/* Success Icon */}
